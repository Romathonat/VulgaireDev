...
STATICFILES_DIRS = (
    ...
    os.path.join(BASE_DIR, "static/ckeditor/plugins/codesnippet/lib/higlights/styles"),
)
    ...
    'default': {
        'toolbar':[['Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord'],
                ...
                ['NumberedList', 'BulletedList', '-',
                 'Outdent', 'Indent'],
                ['Styles', 'Format'],['CodeSnippet','EqnEditor'],
                [ 'Preview' ]],
        'extraPlugins': 'codesnippet,eqneditor,image2',
